...
! function(a) {
	...
	n.DEFAULTS = {
		...
		clearTimeout(this.timeoutId_), this.timeoutId_ = setTimeout(a.proxy(this.grapeHeader, this), this.$el.is(":hidden") ? 100 : 0)
	}, n.prototype.grapeHeader = function() {
		var b, d, e, f, h = this;
		if (h.$el.is(":hidden")) return void(h.timeoutId_ = setTimeout(a.proxy(h.grapeHeader, h), 100));
		...
		}), this.$tableFooter.find("tr").html(e.join("")), clearTimeout(this.timeoutFooter_), this.timeoutFooter_ = setTimeout(a.proxy(this.grapeFooter, this), this.$el.is(":hidden") ? 100 : 0))
	}, n.prototype.grapeFooter = function() {
		var b, c, d;
		return clearTimeout(this.timeoutFooter_), this.$el.is(":hidden") ? void(this.timeoutFooter_ = setTimeout(a.proxy(this.grapeFooter, this), 100)) : (c = this.$el.css("width"), d = c > this.$tableBody.width() ? g() : 0, this.$tableFooter.css({
			"margin-right": d
		...
		this.options.showHeader && this.options.height && this.grapeHeader(), this.options.showFooter && this.grapeFooter()
