...
//控制首页等功能的显示与不显示
function firstLink() {
    firstSpan.innerHTML = "<a href='javascript:firstPage();'><<</a>";
}
...
function preLink() {
    preSpan.innerHTML = "<a href='javascript:prePage();'><</a>";
}
...
function nextLink() {
    nextSpan.innerHTML = "<a href='javascript:nextPage();'>></a></a>";
}
...
function lastLink() {
    lastSpan.innerHTML = "<a href='javascript:lastPage();'>>></a></a></a>";
}
